...
class NavigationController extends ChangeNotifier {
  int _screenGroupIndex = 0;
  int _screenIndex = 0;

  int get screenGroupIndex => _screenGroupIndex;

  int get screenIndex => _screenIndex;

  List<ScreenGroup> get screensGroup => _screensGroup;

  List<Screen> get screenInCurrentGroup =>
      _screensGroup[_screenGroupIndex].screens;

  ScreenGroup get currentScreensGroup => _screensGroup[_screenGroupIndex];

  Screen get currentScreen =>
      _screensGroup[_screenGroupIndex].screens[_screenIndex];

  void setScreenGroup(int index) {
    _screenGroupIndex = index;
    _screenIndex = 0;
    notifyListeners();
  }
  ...
  static const List<ScreenGroup> _screensGroup = [
